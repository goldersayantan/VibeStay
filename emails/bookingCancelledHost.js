            ...
            <div style="max-width:600px;margin:40px auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                ...
                <div style="padding:35px;">
                    ...
                    <p style="font-size:15px;color:#555;line-height:1.6;">
                        A guest has cancelled a confirmed booking for your property.
                        The reserved room inventory has now been released and is available
                        for future bookings.
                    </p>
                    ...
                    <div style="background:#eff6ff;border-left:4px solid #2563eb;padding:15px;border-radius:6px;margin:20px 0;">
                        <p style="margin:0;color:#1e3a8a;font-size:14px;">
                            The cancelled rooms are now available for new reservations and will appear in future searches.
                        </p>
                    </div>
                    ...
                    <p style="font-size:15px;color:#555;">
                        Thank you for hosting with VibeStay.
                    </p>
